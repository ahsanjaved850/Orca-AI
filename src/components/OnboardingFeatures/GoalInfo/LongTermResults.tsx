      ...
      <View style={s.content}>
        ...
        >
          <Text style={s.headline}>
            Orca delivers the plan{"\n"}that you are in search for
          </Text>
        </Animated.View>
        <Image
          source={require("@/assets/images/Onboarding/graph2.png")}
          resizeMode="cover"
          style={{ width: SW * 0.99, height: SH * 0.4, marginTop: 20 }}
        />
        <Animated.View style={[s.noteCard, { opacity: titleAnim }]}>
          <Ionicons name="bulb" size={16} color={COLORS.primary} />
          <Text style={s.noteText}>
            Avoid the risk of 81% bounce back with unsustainable diets and
            achieve lasting results with Orca's.
          </Text>
        </Animated.View>
      </View>
    </View>

...
const CONTENT = {
  ...
  options: [
    { label: "I want to change how I look", emoji: "🪞" },
    { label: "I want to feel better about myself", emoji: "🌸" },
    { label: "I want to improve my health", emoji: "💪" },
  ],
} as const;

export const MotivationQuestion: React.FC<MotivationQuestionProps> = ({
  onValidationChange,
}) => {
